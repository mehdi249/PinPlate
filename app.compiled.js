...
var CUISINES = ["American", "Brazilian", "Cambodian", "Caribbean", "Chinese", "Ethiopian", "Filipino", "French", "Greek", "Hawaiian", "Indian", "Indonesian", "Italian", "Japanese", "Korean", "Lebanese", "Malaysian", "Mediterranean", "Mexican", "Middle Eastern", "Moroccan", "Peruvian", "Spanish", "Taiwanese", "Thai", "Turkish", "Vietnamese", "Other"];
...
function dbToApp(r) {
  return {
    ...
    location: r.location || '',
    recommender: r.recommended_by || '',
    note: r.notes || '',
    status: r.visited ? 'visited' : 'want',
...
function appToDb(f) {
  var _f$hours, _f$photos, _f$reviews;
  return {
    name: f.name,
    cuisine: f.cuisine,
    location: f.location || null,
    recommended_by: f.recommender,
    notes: f.note || null,
    visited: f.status === 'visited',
    rating: f.status === 'visited' ? f.rating || null : null,
    phone: f.phone || null,
    website: f.website || null,
    menu_url: f.menuUrl || null,
    price_range: f.priceRange || null,
    hours: (_f$hours = f.hours) !== null && _f$hours !== void 0 && _f$hours.length ? f.hours : null,
    photos: (_f$photos = f.photos) !== null && _f$photos !== void 0 && _f$photos.length ? f.photos : null,
    reviews: (_f$reviews = f.reviews) !== null && _f$reviews !== void 0 && _f$reviews.length ? f.reviews : null,
    lat: f.lat || null,
    lng: f.lng || null,
...
function parseGoogleMapsUrl(url) {
  ...
  try {
    ...
    if (!out.lat) {
      var dm = url.match(/!3d(-?\d+\.\d+)!4d(-?\d+\.\d+)/);
      if (dm) {
        out.lat = parseFloat(dm[1]);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("span", {
      ...
      onClick: function onClick() {
        return !readonly && onChange && onChange(n);
      },
      style: {
...
var MapView = function MapView(_ref3) {
  ...
  useEffect(function () {
    ...
    return function () {
      var _map$current;
      (_map$current = map.current) === null || _map$current === void 0 || _map$current.remove();
      map.current = null;
    };
  }, []);
  useEffect(function () {
    if (!map.current) return;
    Object.values(marks.current).forEach(function (m) {
      return m.remove();
    });
    marks.current = {};
    var bounds = [];
    spots.forEach(function (r) {
      if (!r.lat || !r.lng) return;
      var visited = r.status === 'visited';
      var bg = visited ? C.sage : C.amber;
      var icon = L.divIcon({
        html: "<div style=\"width:30px;height:30px;background:".concat(bg, ";border-radius:50% 50% 50% 0;transform:rotate(-45deg);border:2.5px solid #fff;box-shadow:0 3px 12px rgba(0,0,0,0.25);display:flex;align-items:center;justify-content:center\"><span style=\"transform:rotate(45deg);color:#fff;font-size:12px;font-weight:700;line-height:1\">").concat(visited ? '✓' : '+', "</span></div>"),
        iconSize: [30, 42],
        iconAnchor: [15, 42],
        className: ''
      });
    ...
    if (bounds.length) map.current.fitBounds(bounds, {
      padding: [60, 60],
      maxZoom: 14
    });
  }, [spots]);
  var unmapped = spots.filter(function (r) {
    return !r.lat || !r.lng;
  });
  function locate() {
    ...
    navigator.geolocation.getCurrentPosition(function (pos) {
      ...
      locateMarker.current = L.circleMarker([lat, lng], {
        radius: 8,
        fillColor: '#4a90d9',
        color: '#fff',
        weight: 2.5,
  ...
  function directions(r) {
    ...
    window.open("https://maps.google.com/maps?daddr=".concat(q), '_blank');
  }
  return /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
  ...
  }), unmapped.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'rgba(253,250,246,0.97)',
      borderRadius: 20,
      padding: '5px 11px',
  ...
  }, unmapped.length, " without pin"))), selected && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      bottom: 20,
      left: 12,
    ...
    style: {
      ...
      gap: 6,
      alignItems: 'center',
      marginBottom: selected.location ? 4 : 0,
      flexWrap: 'wrap'
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      ...
      fontSize: 11,
      fontWeight: 500,
      color: selected.status === 'visited' ? C.sage : C.amber,
      background: selected.status === 'visited' ? C.sageBg : C.amberBg,
      borderRadius: 20,
      padding: '2px 9px'
    }
  }, selected.status === 'visited' ? 'Visited' : 'To Visit'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: C.ui,
      fontSize: 11,
      color: C.dim
  ...
  }, selected.cuisine), selected.priceRange && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: C.ui,
      fontSize: 11,
      color: C.dim
  ...
  }, selected.priceRange))), selected.location && /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: C.ui,
      fontSize: 12,
      color: C.dim,
    ...
    style: {
      ...
      border: "1px solid ".concat(C.amberBd),
      color: C.amber,
      fontFamily: C.ui,
      fontSize: 13,
      fontWeight: 600,
...
// ── Import modal ─────────────────────────────────────────────
var ImportModal = function ImportModal(_ref5) {
  var _form$name;
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            ...
            return _context.a(2);
          case 1:
            isMapsGoo = rawUrl.includes('maps.app.goo.gl') || rawUrl.includes('goo.gl/maps');
            isShort = rawUrl.includes('share.google') || isMapsGoo;
            setBusy(true);
            resolved = rawUrl;
            htmlData = {
              name: '',
  ...
  var inp = {
    ...
    padding: '10px 14px',
    background: C.hi,
    border: "1px solid ".concat(C.bdMid),
    borderRadius: 10,
    fontFamily: C.ui,
    fontSize: 14,
    color: C.text,
  ...
  var canSave = form === null || form === void 0 || (_form$name = form.name) === null || _form$name === void 0 ? void 0 : _form$name.trim();
  return /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      inset: 0,
  ...
  }, step === 'paste' ? 'Import from Maps' : 'Confirm Details'), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      background: 'transparent',
      border: "1px solid ".concat(C.bd),
  ...
  }, "Auto-fills name + location:"), " In Google Maps open the restaurant \u2192 Share \u2192 Open in Safari \u2192 copy the URL.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", {
    style: {
      fontWeight: 600,
      color: C.text
    }
  }, "Saves link only:"), " Short ", /*#__PURE__*/React.createElement("em", null, "share.google/\u2026"), " links \u2014 Google blocks reading them, so you'll add the name manually.")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 18
    }
    ...
    style: {
      ...
      padding: 11,
      borderRadius: 10,
      background: url && !busy ? C.espr : 'rgba(20,10,0,0.08)',
      border: 'none',
      color: url && !busy ? '#fdf8f3' : C.dim,
      fontFamily: C.ui,
      fontSize: 14,
      fontWeight: 500,
      cursor: url && !busy ? 'pointer' : 'default'
    }
  }, busy ? 'Importing…' : 'Import →'))), step === 'preview' && form && /*#__PURE__*/React.createElement(React.Fragment, null, busy && /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: C.ui,
      fontSize: 12,
      color: C.amber,
  ...
  }, "Couldn't auto-fill the name \u2014 type it below.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 14
    ...
    value: form.cuisine,
    onChange: function onChange(e) {
      return set('cuisine', e.target.value);
    }
    ...
    value: form.location,
    onChange: function onChange(e) {
      return set('location', e.target.value);
    }
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    value: form.website,
    onChange: function onChange(e) {
      return set('website', e.target.value);
    },
    ...
    value: form.note,
    onChange: function onChange(e) {
      return set('note', e.target.value);
    },
    placeholder: "What to order, tips\u2026"
  })), form.lat && form.lng && /*#__PURE__*/React.createElement("div", {
    style: {
      background: C.sageBg,
      border: "1px solid ".concat(C.sageBd),
      borderRadius: 10,
      padding: '9px 13px'
    }
  }, /*#__PURE__*/React.createElement("p", {
    ...
    onClick: function onClick() {
      return canSave && onImport(form);
    },
    style: {
      flex: 2,
      padding: 11,
      borderRadius: 10,
      background: canSave ? C.espr : 'rgba(20,10,0,0.08)',
      border: 'none',
      color: canSave ? '#fdf8f3' : C.dim,
      fontFamily: C.ui,
      fontSize: 14,
      fontWeight: 500,
...
// ── Detail panel ─────────────────────────────────────────────
var DetailPanel = function DetailPanel(_ref6) {
  var _r$hours;
  var r = _ref6.r,
    onClose = _ref6.onClose,
    onEdit = _ref6.onEdit,
    onMarkVisited = _ref6.onMarkVisited,
    onRate = _ref6.onRate,
    onDelete = _ref6.onDelete;
  var _useState1 = useState(false),
    _useState10 = _slicedToArray(_useState1, 2),
    hoursOpen = _useState10[0],
    setHoursOpen = _useState10[1];
  var openUrl = function openUrl(url) {
    return window.open(url.startsWith('http') ? url : 'https://' + url, '_blank');
  };
  function directions() {
    var q = r.lat && r.lng ? "".concat(r.lat, ",").concat(r.lng) : encodeURIComponent([r.name, r.location].filter(Boolean).join(' '));
    window.open("https://maps.google.com/maps?daddr=".concat(q), '_blank');
  ...
  function call() {
    if (r.phone) window.location = 'tel:' + r.phone.replace(/[^\d+]/g, '');
  }
  function menu() {
    if (r.menuUrl) return openUrl(r.menuUrl);
    window.open("https://www.google.com/search?q=".concat(encodeURIComponent(r.name + ' ' + (r.location || '') + ' menu')), '_blank');
  }
  function share() {
    var _navigator$clipboard;
    var url = r.googleMapsUrl || "https://www.google.com/maps/search/".concat(encodeURIComponent(r.name));
    if (navigator.share) navigator.share({
      title: r.name,
      url: url
    });else (_navigator$clipboard = navigator.clipboard) === null || _navigator$clipboard === void 0 || _navigator$clipboard.writeText(url);
  }
  function openInMaps() {
    openUrl(r.googleMapsUrl || "https://www.google.com/maps/search/".concat(encodeURIComponent([r.name, r.location].filter(Boolean).join(' '))));
  }
  var isVisited = r.status === 'visited';
  var accent = isVisited ? C.sage : C.amber;
  var accentBg = isVisited ? C.sageBg : C.amberBg;
  var photos = (r.photos || []).filter(function (p) {
  ...
  var row = function row(icon, content, onTap) {
    ...
    }, content), onTap && /*#__PURE__*/React.createElement("span", {
      style: {
        color: C.dim,
        fontSize: 16,
        flexShrink: 0
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, isVisited ? 'Visited' : 'To Visit'), /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.bd
    }
  }, "\xB7"), /*#__PURE__*/React.createElement("span", {
  ...
  }, r.cuisine), r.priceRange && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.bd
    }
  }, "\xB7"), /*#__PURE__*/React.createElement("span", {
  ...
  }, r.priceRange)), r.rating && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    style: {
      color: C.bd
    }
  }, "\xB7"), /*#__PURE__*/React.createElement(StarRating, {
    value: r.rating,
    readonly: true,
    size: 12
  ...
  }, r.location), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: C.ui,
      fontSize: 12,
      color: C.dim,
  ...
  }, "Open in Google Maps")), openInMaps), r.location && divider, ((_r$hours = r.hours) === null || _r$hours === void 0 ? void 0 : _r$hours.length) > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    onClick: function onClick() {
      return setHoursOpen(function (v) {
        return !v;
      });
    },
    style: {
    ...
    style: {
      ...
      transform: hoursOpen ? 'rotate(90deg)' : 'none'
    }
  }, "\u203A")), hoursOpen && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '0 18px 14px 56px'
    }
  }, r.hours.map(function (h, i) {
    return /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: 'flex',
        justifyContent: 'space-between',
        padding: '4px 0',
        borderBottom: i < r.hours.length - 1 ? "1px solid ".concat(C.bd) : 'none'
      }
    }, /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: C.ui,
    ...
    }, h.day), /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: C.ui,
        fontSize: 13,
        color: h.time === 'Closed' ? C.red : C.sage,
        fontWeight: 500
      }
    }, h.time));
  })), divider), r.phone && /*#__PURE__*/React.createElement(React.Fragment, null, row(/*#__PURE__*/React.createElement(Ic, {
    n: "phone",
    size: 16
  }), /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, r.phone), call), divider), r.website && /*#__PURE__*/React.createElement(React.Fragment, null, row(/*#__PURE__*/React.createElement(Ic, {
    n: "globe",
    size: 16
  }), /*#__PURE__*/React.createElement("span", {
    style: {
    ...
    return openUrl(r.website);
  }), divider), r.note && /*#__PURE__*/React.createElement(React.Fragment, null, row(/*#__PURE__*/React.createElement(Ic, {
    n: "chat",
    size: 16
  }), /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, r.recommender ? 'Note from ' + r.recommender : 'Note'), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: C.display,
      fontSize: 15,
      color: C.text,
  ...
  }, "\"", r.note, "\""))), divider), r.recommender && /*#__PURE__*/React.createElement(React.Fragment, null, row(/*#__PURE__*/React.createElement(Ic, {
    n: "person",
    size: 16
  }), /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, "Recommended by"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: C.ui,
      fontSize: 14,
      color: C.text,
  ...
  }, r.recommender))), divider), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 16,
    ...
    style: {
      ...
      borderTop: "1px solid ".concat(C.bd),
      display: 'flex',
      gap: 10,
      background: C.hi
    }
    ...
    style: {
      ...
      borderRadius: 12,
      background: C.sageBg,
      border: "1.5px solid ".concat(C.sageBd),
      color: C.sage,
      fontFamily: C.ui,
      fontSize: 14,
      fontWeight: 600,
    ...
    style: {
      ...
      borderRadius: 12,
      background: C.redBg,
      border: "1px solid ".concat(C.redBd),
      color: C.red,
      cursor: 'pointer',
      display: 'flex',
      alignItems: 'center',
...
// ── Add / Edit modal ─────────────────────────────────────────
var EditModal = function EditModal(_ref7) {
  var onClose = _ref7.onClose,
    onSave = _ref7.onSave,
    editData = _ref7.editData;
  var _useState11 = useState(editData || {
      name: '',
      cuisine: 'Italian',
      location: '',
      recommender: '',
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, editData ? 'Edit Restaurant' : 'Add Manually'), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      background: 'transparent',
      border: "1px solid ".concat(C.bd),
    ...
    style: lbl
  }, "Menu URL"), /*#__PURE__*/React.createElement("input", {
    style: inp,
    value: form.menuUrl,
    onChange: function onChange(e) {
      return set('menuUrl', e.target.value);
    },
    placeholder: "restaurant.com/menu"
  }))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: lbl
  }, "Phone"), /*#__PURE__*/React.createElement("input", {
    style: inp,
    ...
    placeholder: "What to order, tips, vibes\u2026"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: lbl
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        padding: 10,
        borderRadius: 10,
        border: "1.5px solid ".concat(form.status === s ? C.amber : C.bd),
        background: form.status === s ? C.amberBg : 'transparent',
        color: form.status === s ? C.amber : C.dim,
        fontFamily: C.ui,
        fontSize: 13,
        fontWeight: 500,
        cursor: 'pointer',
    ...
    onClick: function onClick() {
      return ok && onSave(form);
    },
    style: {
      flex: 2,
      padding: 11,
      borderRadius: 10,
      background: ok ? C.espr : 'rgba(20,10,0,0.08)',
      border: 'none',
      color: ok ? '#fdf8f3' : C.dim,
      fontFamily: C.ui,
      fontSize: 14,
      fontWeight: 500,
...
var Card = function Card(_ref8) {
  var r = _ref8.r,
    ...
    isPriority = _ref8.isPriority,
    priorityNum = _ref8.priorityNum,
    priorityTotal = _ref8.priorityTotal,
    onTogglePriority = _ref8.onTogglePriority,
  ...
  }, r.cuisine), r.location && /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: C.ui,
      fontSize: 11,
      color: C.dim
...
var Feed = function Feed(_ref9) {
  ...
  function movePriority(id, dir) {
    setPriority(function (prev) {
      ...
      var _ref0 = [next[newIdx], next[idx]];
      next[idx] = _ref0[0];
      next[newIdx] = _ref0[1];
      savePriorityList(next);
      return next;
  ...
  var show = cuisine === 'All' ? restaurants : restaurants.filter(function (r) {
    return r.cuisine === cuisine;
  });
  var wantList = show.filter(function (r) {
  ...
  var toggleBtn = function toggleBtn(key, label, count, accent, accentBg, accentBd) {
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        padding: '14px 10px',
        borderRadius: 14,
        border: "2px solid ".concat(section === key ? accent : C.bd),
        background: section === key ? accentBg : 'transparent',
        cursor: 'pointer',
      ...
      style: {
        fontFamily: C.display,
        fontSize: 18,
        color: section === key ? accent : C.dim,
        marginBottom: 2
      }
  ...
  }, ['All'].concat(_toConsumableArray(cuisines)).map(function (c) {
    return /*#__PURE__*/React.createElement("button", {
      key: c,
      onClick: function onClick() {
        return setCuisine(c);
      ...
      style: {
        ...
        padding: '6px 14px',
        borderRadius: 20,
        border: "1px solid ".concat(cuisine === c ? C.espr : C.bd),
        background: cuisine === c ? C.espr : 'transparent',
        color: cuisine === c ? '#fdf8f3' : C.mid,
        fontFamily: C.ui,
        fontSize: 12,
        fontWeight: 500,
        cursor: 'pointer',
...
var SignIn = function SignIn() {
  ...
  function _signIn() {
    _signIn = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
  ...
  }, "PinPlate"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: C.ui,
      fontSize: 13,
      color: C.dim,
  ...
  }, "Your personal city guide"), /*#__PURE__*/React.createElement("div", {
    style: {
      width: '100%',
      maxWidth: 340,
      background: C.hi,
...
var PENDING_SPOTS = [{
  ...
  recommended_by: '',
  notes: 'Tacos, enchiladas & Mexican classics · margaritas · outdoor seating · vegan options · closes 9pm',
  visited: false,
  price_range: '$10-20',
  phone: '604-544-5006',
  website: '',
  ...
  name: 'Osteria Elio Volpe',
  cuisine: 'Italian',
  location: '540 W 17th Ave, Vancouver, BC',
  recommended_by: '',
  notes: 'Italian · reservations required · great cocktails · vegetarian options',
  visited: false,
  price_range: '',
  phone: '236-471-9564',
...
function App() {
  ...
  // Auth state
  useEffect(function () {
    sb.auth.getSession().then(function (_ref1) {
      var session = _ref1.data.session;
      setSession(session);
      setAuthChecked(true);
    });
    var _sb$auth$onAuthStateC = sb.auth.onAuthStateChange(function (_ev, session) {
        setSession(session);
      }),
  ...
  var filtered = useMemo(function () {
    ...
    return restaurants.filter(function (r) {
      return !q || r.name.toLowerCase().includes(q) || r.cuisine.toLowerCase().includes(q) || r.recommender.toLowerCase().includes(q) || (r.location || '').toLowerCase().includes(q);
    });
  }, [restaurants, search]);
  var wantList = filtered.filter(function (r) {
    return r.status === 'want';
  });
        ...
        while (1) switch (_context6.n) {
          ...
          case 2:
            ...
            setDetail(function (d) {
              return (d === null || d === void 0 ? void 0 : d.id) === id ? _objectSpread(_objectSpread({}, d), {}, {
                status: 'visited'
              }) : d;
            });
  ...
  var wantCount = restaurants.filter(function (r) {
    return r.status === 'want';
  }).length;
  var visitedCount = restaurants.filter(function (r) {
    return r.status === 'visited';
  }).length;

  // Auth guards — show nothing until we know the auth state
  if (!authChecked) return /*#__PURE__*/React.createElement("div", {
    style: {
      minHeight: '100vh',
      display: 'flex',
      alignItems: 'center',
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, "\n      @import url('https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Inter:wght@300;400;500;600&display=swap');\n      *{box-sizing:border-box;margin:0;padding:0;}\n      body{background:".concat(C.bg, ";-webkit-text-size-adjust:100%;}\n      ::placeholder{color:").concat(C.dim, "!important;opacity:0.7;}\n      ::-webkit-scrollbar{width:4px;}\n      ::-webkit-scrollbar-track{background:transparent;}\n      ::-webkit-scrollbar-thumb{background:rgba(0,0,0,0.12);border-radius:4px;}\n      select option{background:").concat(C.hi, ";}\n      .leaflet-container{font-family:'Inter',system-ui,sans-serif!important;}\n      @keyframes fadeIn{from{opacity:0}to{opacity:1}}\n      @keyframes slideUp{from{opacity:0;transform:translateY(20px) scale(0.98)}to{opacity:1;transform:none}}\n    ")), /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      borderBottom: "1px solid ".concat(C.bd)
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 560,
  ...
  }, wantCount, " to visit \xB7 ", visitedCount, " visited", /*#__PURE__*/React.createElement("button", {
    onClick: function onClick() {
    ...
    style: {
      ...
      textDecorationColor: 'rgba(168,144,122,0.4)'
    }
    ...
    onClick: function onClick() {
      return setShowAddMenu(function (v) {
        return !v;
      });
    },
    style: {
  ...
  }, "+ Add"), showAddMenu && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      top: 'calc(100% + 8px)',
      right: 0,
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        borderBottom: "2px solid ".concat(tab === t.k ? C.amber : 'transparent'),
        transition: 'all 0.15s',
        marginBottom: -1
      }
    }, t.l);
  ...
  }))), tab === 'home' && (loading ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '70px 0'
    }
  ...
  }, "Loading\u2026")) : /*#__PURE__*/React.createElement(Feed, {
    restaurants: filtered,
    onCardClick: setDetail
  })), tab === 'map' && !loading && /*#__PURE__*/React.createElement(MapView, {
    spots: restaurants,
    onMarkerClick: function onMarkerClick(r) {
      return setDetail(r);
    }
    ...
    onClick: function onClick() {
      return setShowAddMenu(false);
    }
  }), detail && /*#__PURE__*/React.createElement(DetailPanel, {
    r: detail,
    onClose: function onClose() {
      return setDetail(null);
    },
    onEdit: function onEdit(r) {
      setEditTarget(r);
      setDetail(null);
      setShowEdit(true);
    },
